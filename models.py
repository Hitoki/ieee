...
class NodeManager(models.Manager):
    ...
    def get_extra_info(self, queryset, order_by=None, selected_filter_ids=None):
        ...
        num_resources_sql = "SELECT child_resources_sum_or_avg(ieeetags_node.id)"
        
        num_societies_sql = "SELECT child_societies_sum_or_avg(ieeetags_node.id)"
        
        num_filters_sql = 'SELECT COUNT(*) FROM ieeetags_node_filters WHERE ieeetags_node_filters.node_id = ieeetags_node.id'
        
        num_sectors_sql = "SELECT sectors_sum_or_avg(ieeetags_node.id)"
        
        num_related_tags_sql = "SELECT related_tags_sum_or_avg(ieeetags_node.id)"
