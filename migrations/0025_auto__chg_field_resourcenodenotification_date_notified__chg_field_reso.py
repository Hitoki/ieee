...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ResourceNodeNotification.date_notified'
        db.alter_column('ieeetags_resourcenodenotification', 'date_notified', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'ResourceNodeNotificationRequest.date_created'
        db.alter_column('ieeetags_resourcenodenotificationrequest', 'date_created', self.gf('django.db.models.fields.DateTimeField')())


    def backwards(self, orm):
        
        # Changing field 'ResourceNodeNotification.date_notified'
        db.alter_column('ieeetags_resourcenodenotification', 'date_notified', self.gf('django.db.models.fields.DateField')())

        # Changing field 'ResourceNodeNotificationRequest.date_created'
        db.alter_column('ieeetags_resourcenodenotificationrequest', 'date_created', self.gf('django.db.models.fields.DateField')())
