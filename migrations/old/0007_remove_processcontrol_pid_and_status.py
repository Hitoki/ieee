...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ProcessControl.status'
        db.delete_column('ieeetags_processcontrol', 'status')

        # Deleting field 'ProcessControl.pid'
        db.delete_column('ieeetags_processcontrol', 'pid')

        # Changing field 'ProcessControl.is_alive'
        db.alter_column('ieeetags_processcontrol', 'is_alive', self.gf('django.db.models.fields.BooleanField')(blank=True))

    def backwards(self, orm):
        
        # Adding field 'ProcessControl.status'
        db.add_column('ieeetags_processcontrol', 'status', self.gf('django.db.models.fields.CharField')(default='RUNNING', max_length=100), keep_default=False)

        # Adding field 'ProcessControl.pid'
        db.add_column('ieeetags_processcontrol', 'pid', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Changing field 'ProcessControl.is_alive'
        db.alter_column('ieeetags_processcontrol', 'is_alive', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        'ieeetags.resourcenodes': {
            ...
            'node': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ieeetags.Node']"}),
            'resource': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ieeetags.Resource']"})
        },
