...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ProcessControl'
        db.create_table('ieeetags_processcontrol', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('status', self.gf('django.db.models.fields.CharField')(default='RUNNING', max_length=100)),
            ('log', self.gf('django.db.models.fields.CharField')(max_length=1000, blank=True)),
        ...
        db.send_create_signal('ieeetags', ['ProcessControl'])


    def backwards(self, orm):
        
        # Deleting model 'ProcessControl'
        db.delete_table('ieeetags_processcontrol')
    ...
    models = {
        ...
        'ieeetags.processcontrol': {
            ...
            'status': ('django.db.models.fields.CharField', [], {'default': "'RUNNING'", 'max_length': '100'}),
