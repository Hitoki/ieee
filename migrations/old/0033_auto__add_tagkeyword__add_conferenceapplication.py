...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TagKeyword'
        db.create_table('ieeetags_tagkeyword', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ieeetags.Node'], null=True)),
        ))
        db.send_create_signal('ieeetags', ['TagKeyword'])

        # Adding model 'ConferenceApplication'
        db.create_table('ieeetags_conferenceapplication', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('ieeetags', ['ConferenceApplication'])

        # Adding M2M table for field keywords on 'ConferenceApplication'
        db.create_table('ieeetags_conferenceapplication_keywords', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('conferenceapplication', models.ForeignKey(orm['ieeetags.conferenceapplication'], null=False)),
            ('tagkeyword', models.ForeignKey(orm['ieeetags.tagkeyword'], null=False))
        ))
        db.create_unique('ieeetags_conferenceapplication_keywords', ['conferenceapplication_id', 'tagkeyword_id'])


    def backwards(self, orm):
        # Deleting model 'TagKeyword'
        db.delete_table('ieeetags_tagkeyword')

        # Deleting model 'ConferenceApplication'
        db.delete_table('ieeetags_conferenceapplication')

        # Removing M2M table for field keywords on 'ConferenceApplication'
        db.delete_table('ieeetags_conferenceapplication_keywords')
