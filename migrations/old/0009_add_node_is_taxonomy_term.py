...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Node.is_taxonomy_term'
        db.add_column('ieeetags_node', 'is_taxonomy_term', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Node.is_taxonomy_term'
        db.delete_column('ieeetags_node', 'is_taxonomy_term')
