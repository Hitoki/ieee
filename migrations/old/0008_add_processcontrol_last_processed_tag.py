...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProcessControl.last_processed_tag'
        db.add_column('ieeetags_processcontrol', 'last_processed_tag', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['ieeetags.Node'], null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'ProcessControl.last_processed_tag'
        db.delete_column('ieeetags_processcontrol', 'last_processed_tag_id')
