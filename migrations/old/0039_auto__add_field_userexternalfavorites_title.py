...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserExternalFavorites.title'
        db.add_column('ieeetags_userexternalfavorites', 'title',
                      self.gf('django.db.models.fields.CharField')(default='Untitled', max_length=500),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserExternalFavorites.title'
        db.delete_column('ieeetags_userexternalfavorites', 'title')
