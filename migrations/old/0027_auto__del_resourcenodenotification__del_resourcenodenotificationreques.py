...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'ResourceNodeNotification'
        db.delete_table('ieeetags_resourcenodenotification')

        # Deleting model 'ResourceNodeNotificationRequest'
        db.delete_table('ieeetags_resourcenodenotificationrequest')

        # Adding model 'ResourceAdditionNotificationRequest'
        db.create_table('ieeetags_resourceadditionnotificationrequest', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('node', self.gf('django.db.models.fields.related.ForeignKey')(related_name='notification_node', to=orm['ieeetags.Node'])),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')()),
            ('email', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('ieeetags', ['ResourceAdditionNotificationRequest'])

        # Adding model 'ResourceAdditionNotification'
        db.create_table('ieeetags_resourceadditionnotification', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('request', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ieeetags.ResourceAdditionNotificationRequest'])),
            ('resourceNodes', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ieeetags.ResourceNodes'], null=True)),
            ('resourceSocieties', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ieeetags.NodeSocieties'], null=True)),
            ('date_notified', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('ieeetags', ['ResourceAdditionNotification'])


    def backwards(self, orm):
        
        # Adding model 'ResourceNodeNotification'
        db.create_table('ieeetags_resourcenodenotification', (
            ('request', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ieeetags.ResourceNodeNotificationRequest'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date_notified', self.gf('django.db.models.fields.DateTimeField')()),
            ('resourceNodes', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ieeetags.ResourceNodes'])),
        ))
        db.send_create_signal('ieeetags', ['ResourceNodeNotification'])

        # Adding model 'ResourceNodeNotificationRequest'
        db.create_table('ieeetags_resourcenodenotificationrequest', (
            ('node', self.gf('django.db.models.fields.related.ForeignKey')(related_name='notification_node', to=orm['ieeetags.Node'])),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')()),
            ('email', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('ieeetags', ['ResourceNodeNotificationRequest'])

        # Deleting model 'ResourceAdditionNotificationRequest'
        db.delete_table('ieeetags_resourceadditionnotificationrequest')

        # Deleting model 'ResourceAdditionNotification'
        db.delete_table('ieeetags_resourceadditionnotification')
    ...
    models = {
        ...
        'ieeetags.resourceadditionnotification': {
            'Meta': {'object_name': 'ResourceAdditionNotification'},
            'date_notified': ('django.db.models.fields.DateTimeField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'request': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ieeetags.ResourceAdditionNotificationRequest']"}),
            'resourceNodes': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ieeetags.ResourceNodes']", 'null': 'True'}),
            'resourceSocieties': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ieeetags.NodeSocieties']", 'null': 'True'})
        },
        'ieeetags.resourceadditionnotificationrequest': {
            'Meta': {'object_name': 'ResourceAdditionNotificationRequest'},
