...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProfileLog.category'
        db.add_column('ieeetags_profilelog', 'category', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ProfileLog.category'
        db.delete_column('ieeetags_profilelog', 'category')
