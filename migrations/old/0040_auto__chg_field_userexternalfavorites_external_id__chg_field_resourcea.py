...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserExternalFavorites.external_id'
        db.alter_column('ieeetags_userexternalfavorites', 'external_id', self.gf('django.db.models.fields.CharField')(max_length=500))

        # Changing field 'ResourceAdditionNotificationRequest.date_created'
        db.alter_column('ieeetags_resourceadditionnotificationrequest', 'date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'UserExternalFavorites.external_id'
        db.alter_column('ieeetags_userexternalfavorites', 'external_id', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'ResourceAdditionNotificationRequest.date_created'
        db.alter_column('ieeetags_resourceadditionnotificationrequest', 'date_created', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        'ieeetags.conferenceapplication': {
            'Meta': {'object_name': 'ConferenceApplication'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'keywords': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'conference_applications'", 'symmetrical': 'False', 'to': "orm['ieeetags.TagKeyword']"}),
        ...
        'ieeetags.resourceadditionnotificationrequest': {
            'Meta': {'unique_together': "(('node', 'email'),)", 'object_name': 'ResourceAdditionNotificationRequest'},
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
        ...
        'ieeetags.tagkeyword': {
            'Meta': {'object_name': 'TagKeyword'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
            'tag': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ieeetags.Node']", 'null': 'True'})
        },
        ...
        'ieeetags.userexternalfavorites': {
            'Meta': {'object_name': 'UserExternalFavorites'},
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'external_id': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
            'external_resource_type': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'default': "'Untitled'", 'max_length': '500'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
        'ieeetags.userfavorites': {
            'Meta': {'object_name': 'UserFavorites'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'resources': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'user_favorite_resources'", 'blank': 'True', 'to': "orm['ieeetags.Resource']"}),
            'societies': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'user_favorite_societies'", 'blank': 'True', 'to': "orm['ieeetags.Society']"}),
            'topics': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'user_favorite_topics'", 'blank': 'True', 'to': "orm['ieeetags.Node']"}),
