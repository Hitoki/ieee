...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserExternalFavorites'
        db.create_table('ieeetags_userexternalfavorites', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('external_resource_type', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('external_id', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('ieeetags', ['UserExternalFavorites'])
