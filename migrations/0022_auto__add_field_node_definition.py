...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Node.definition'
        db.add_column('ieeetags_node', 'definition', self.gf('django.db.models.fields.CharField')(max_length=2000, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Node.definition'
        db.delete_column('ieeetags_node', 'definition')
