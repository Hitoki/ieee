...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field societies on 'UserFavorites'
        db.create_table('ieeetags_userfavorites_societies', (
        ...
        db.create_unique('ieeetags_userfavorites_societies', ['userfavorites_id', 'society_id'])


    def backwards(self, orm):
        # Removing M2M table for field societies on 'UserFavorites'
        db.delete_table('ieeetags_userfavorites_societies')
