...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Resource.pub_id'
        db.add_column('ieeetags_resource', 'pub_id', self.gf('django.db.models.fields.CharField')(default='', max_length=1000, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Resource.pub_id'
        db.delete_column('ieeetags_resource', 'pub_id')
