...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Node.high_potency'
        db.add_column('ieeetags_node', 'high_potency', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Node.high_potency'
        db.delete_column('ieeetags_node', 'high_potency')
