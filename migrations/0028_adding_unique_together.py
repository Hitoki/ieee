...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ResourceAdditionNotificationRequest', fields ['node', 'email']
        db.create_unique('ieeetags_resourceadditionnotificationrequest', ['node_id', 'email'])


    def backwards(self, orm):
        # Removing unique constraint on 'ResourceAdditionNotificationRequest', fields ['node', 'email']
        db.delete_unique('ieeetags_resourceadditionnotificationrequest', ['node_id', 'email'])
