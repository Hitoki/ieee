...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing M2M table for field favorites on 'UserFavorites'
        db.delete_table('ieeetags_userfavorites_favorites')

        # Adding M2M table for field topics on 'UserFavorites'
        db.create_table('ieeetags_userfavorites_topics', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userfavorites', models.ForeignKey(orm['ieeetags.userfavorites'], null=False)),
            ('node', models.ForeignKey(orm['ieeetags.node'], null=False))
        ))
        db.create_unique('ieeetags_userfavorites_topics', ['userfavorites_id', 'node_id'])

        # Adding M2M table for field resources on 'UserFavorites'
        db.create_table('ieeetags_userfavorites_resources', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userfavorites', models.ForeignKey(orm['ieeetags.userfavorites'], null=False)),
            ('resource', models.ForeignKey(orm['ieeetags.resource'], null=False))
        ))
        db.create_unique('ieeetags_userfavorites_resources', ['userfavorites_id', 'resource_id'])


    def backwards(self, orm):
        # Adding M2M table for field favorites on 'UserFavorites'
        db.create_table('ieeetags_userfavorites_favorites', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userfavorites', models.ForeignKey(orm['ieeetags.userfavorites'], null=False)),
            ('node', models.ForeignKey(orm['ieeetags.node'], null=False))
        ))
        db.create_unique('ieeetags_userfavorites_favorites', ['userfavorites_id', 'node_id'])

        # Removing M2M table for field topics on 'UserFavorites'
        db.delete_table('ieeetags_userfavorites_topics')

        # Removing M2M table for field resources on 'UserFavorites'
        db.delete_table('ieeetags_userfavorites_resources')
