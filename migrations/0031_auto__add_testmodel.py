...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ieeetags_testmodel', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('test_field', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('ieeetags', ['TestModel'])


    def backwards(self, orm):
        # Deleting model 'TestModel'
        db.delete_table('ieeetags_testmodel')
