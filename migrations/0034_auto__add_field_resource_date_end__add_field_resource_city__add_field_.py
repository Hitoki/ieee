...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Resource.date_end'
        db.add_column('ieeetags_resource', 'date_end',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Resource.city'
        db.add_column('ieeetags_resource', 'city',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Resource.state_province'
        db.add_column('ieeetags_resource', 'state_province',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Resource.country'
        db.add_column('ieeetags_resource', 'country',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Resource.date_end'
        db.delete_column('ieeetags_resource', 'date_end')

        # Deleting field 'Resource.city'
        db.delete_column('ieeetags_resource', 'city')

        # Deleting field 'Resource.state_province'
        db.delete_column('ieeetags_resource', 'state_province')

        # Deleting field 'Resource.country'
        db.delete_column('ieeetags_resource', 'country')
