...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        '''Creates the "MGA" and "IEEE USA" societies (if necessary).'''
        
        try:
            soc = orm.Society.objects.get(abbreviation='IEEE-USA')
        except orm.Society.DoesNotExist:
            soc = orm.Society()
        
        soc.name = 'IEEE USA'
        soc.abbreviation = 'IEEE-USA'
        soc.url = 'http://www.ieeeusa.org/'
        soc.logo_full = 'images/sc_logos/full/ieee-usa.jpg'
        soc.logo_thumbnail = 'images/sc_logos/thumbnail/ieee-usa.jpg'
        soc.save()
        
        try:
            soc = orm.Society.objects.get(abbreviation='MGA')
        except orm.Society.DoesNotExist:
            soc = orm.Society()
            
        soc.name = 'Member and Geographic Activities'
        soc.abbreviation = 'MGA'
        soc.url = 'http://ieee.org/societies_communities/geo_activities/index.html'
        soc.logo_full = 'images/sc_logos/full/mga.jpg'
        soc.logo_thumbnail = 'images/sc_logos/thumbnail/mga.jpg'
        soc.save()
