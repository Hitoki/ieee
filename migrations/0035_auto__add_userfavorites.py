...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserFavorites'
        db.create_table('ieeetags_userfavorites', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
        ))
        db.send_create_signal('ieeetags', ['UserFavorites'])
    ...
    def backwards(self, orm):
        # Deleting model 'UserFavorites'
        db.delete_table('ieeetags_userfavorites')
    ...
    models = {
        ...
        'ieeetags.userfavorites': {
            ...
            'favorites': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'user_favorites'", 'blank': 'True', 'to': "orm['ieeetags.Node']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
