...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Node.definition_source'
        db.add_column('ieeetags_node', 'definition_source', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)

        # Adding field 'Node.definition_updated_when'
        db.add_column('ieeetags_node', 'definition_updated_when', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Node.definition_source'
        db.delete_column('ieeetags_node', 'definition_source')

        # Deleting field 'Node.definition_updated_when'
        db.delete_column('ieeetags_node', 'definition_updated_when')
