...
urlpatterns += patterns(
    ...
    url(r'^import/xplore$', views.import_xplore, name='admin_import_xplore'),
    url(r'^import/xplore_log/(?P<filename>[^/]+)$', views.import_xplore_log, name='admin_import_xplore_log'),
    url(r'^import/xplore_download_log/(?P<filename>[^/]+)$', views.import_xplore_download_log, name='admin_import_xplore_download_log'),
    url(r'^import/xplore_delete_log/(?P<filename>[^/]+)$', views.import_xplore_delete_log, name='admin_import_xplore_delete_log'),
    ...
    url(r'^cluster/(?P<cluster_id>\d+)/edit2$', views.edit_cluster2, name='admin_edit_cluster2'),
    url(r'^cluster/create$', views.edit_cluster, name='admin_create_cluster'),
    url(r'^cluster/create2$', views.edit_cluster2, name='admin_create_cluster2'),
    ...
    url(r'^report/conference_series/(?P<conference_series>[^/]+)$', views.conference_series_report2, name='admin_conference_series_report2'),
